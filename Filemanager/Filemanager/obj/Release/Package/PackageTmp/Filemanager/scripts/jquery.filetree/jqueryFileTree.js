...
if (jQuery) (function ($) {
    ...
    $.extend($.fn, {       
		...
		fileTree: function(o, h) {
			...
			if (o.server == undefined) o.server = false;
			...
			$(this).each( function() {
			    ...
			    function showTree(c, t) {
			        function showData(data) {			                			                
			                ...
			                bindTree(c);
			                if (o.expandedFolder != null && o.expandedFolder) {
			                    $(c).find(".directory.collapsed").each(function (i, f) {
			                        if ((o.expandedFolder).match($(f).children().attr('data-path')) || o.expandedFolder == "All") {
				...
				function bindTree(t) {
				    $(t).find('LI A').unbind(o.folderEvent).bind(o.folderEvent, function () {
				        o.expandedFolder = "";
						...
						if( $(this).parent().hasClass('directory') ) {
							if( $(this).parent().hasClass('collapsed') ) {
								...
								if (o.server) {
								    ...
								    $(this).parent().find('UL').first().slideDown({ duration: o.collapseSpeed, easing: o.collapseEasing });
								    $(this).parent().find('UL').first().parent().removeClass('collapsed').addClass('expanded');
								}
							    ...
							    $(this).parent().find('UL').parent().removeClass('expanded').addClass('collapsed');							    							    
				    ...
				    $(t).find('LI A').bind("updateTree", function () {				        			        

				        updateTree($(this).parent(), $(this).attr('data-path').match(/.*\//));
